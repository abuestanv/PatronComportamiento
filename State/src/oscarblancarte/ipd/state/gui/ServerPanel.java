...
public class ServerPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnShutDownSecure = new javax.swing.JButton();
        ...
        btnShutDownSecure.setText("Secure Shutdown");
        btnShutDownSecure.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                shutdownSecureAction(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btnShutDownSecure, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnShutDownSecure, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnSendMessage, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void startAction(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startAction
        ...
        if (state instanceof ShutdownSecureState) {
            System.out.println("Secure shutdiwn in progress....");
            return;
        }
    ...
    private void shutdownSecureAction(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shutdownSecureAction
        // TODO add your handling code here:
        AbstractServerState state = server.getState();
        if (state instanceof StopServerState) {
    ...
    }//GEN-LAST:event_shutdownSecureAction
